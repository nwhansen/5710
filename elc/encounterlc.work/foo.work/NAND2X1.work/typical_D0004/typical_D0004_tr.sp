* * design : NAND2X1 / process : typical / id : D0004 (2014/10/29 20:34:37) * *
...
V_B B 0 vsource type = pwl wave = [ 0  0  0.1n  0  (0.1n+param_ts_B)  5  80n  5  ]
...
.measure tran delay_D0004 trig v(B) val=1.500000 cross=1 targ v(Y) val=1.500000 cross=1
.measure tran slew_D0004 trig v(Y) val=1.000000 cross=1 targ v(Y) val=4.000000 cross=1
simulator lang=spectre insensitive=no
a0 altergroup {
parameters param_ts_B=0.1n
parameters param_cl_Y=25f
