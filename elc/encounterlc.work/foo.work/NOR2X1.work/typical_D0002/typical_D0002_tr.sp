* * design : NOR2X1 / process : typical / id : D0002 (2014/10/29 20:34:37) * *
...
.measure tran delay_D0002 trig v(A) val=3.500000 cross=1 targ v(Y) val=3.500000 cross=1
.measure tran slew_D0002 trig v(Y) val=1.000000 cross=1 targ v(Y) val=4.000000 cross=1
simulator lang=spectre insensitive=no
a0 altergroup {
parameters param_ts_A=0.1n
parameters param_cl_Y=25f
