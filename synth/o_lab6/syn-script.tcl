...
set target_library [list Lib6710_08.db]
...
set myFiles [list counter.v]
set fileFormat verilog    ;# verilog or VHDL
set basename counter      ;# Top-level module name
...
set myLoadLibrary Lib6710_08 ;# name of library the cell comes from
set myLoadPin A       ;# name of pin that outputs drive


# Control the writing of result files				
set runname outstruct      ;# Name appended to output files
